...
const strings = new (LocalizedStrings as any)({
  ...
  en: {
    ...
    searchRadiusExplanation: `Search radius is in either miles or km, depending on the root server settings.
      A negative value must be an integer, and is for auto-radius.`,
    searchString: 'Search for specific text',
    searchStringExplanation: 'If you do not enter any text, it will have no effect on the search.',
