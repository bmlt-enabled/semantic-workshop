...
const strings = new (LocalizedStrings as any)({
  de: {
    ...
    field: 'Field',
    formatIds: 'Nach spezifischen Format-IDs filtern',
    formatIdsExclude: 'Spezifische Format-IDs ausschließen',
    formatIdsExcludeExplanation: 'Wählen Sie Format-IDs aus, die von den Ergebnissen ausgeschlossen werden sollen. Wenn keine ausgewählt sind, werden keine Formate ausgeschlossen.',
    formatIdsExplanation: 'Wählen Sie Format-IDs aus, die in den Ergebnissen enthalten sein sollen. Wenn keine ausgewählt sind, werden alle Formate einbezogen.',
    formatKeyStrings: 'Nach Format-Schlüsselstrings filtern',
    formatKeyStringsExplanation: 'Wählen Sie Format-Schlüsselstrings zum Filtern aus. Wenn keine ausgewählt sind, werden alle Formate berücksichtigt.',
    ...
    language: 'Sprache',
    meetingIds: 'Suche nach spezifischen Meeting-IDs',
    meetingIdsExclude: 'Spezifische Meeting-IDs ausschließen',
    meetingIdsExcludeExplanation:
      'Geben Sie Meeting-IDs ein, die aus den Suchergebnissen ausgeschlossen werden sollen, getrennt durch Kommas. Wenn leer gelassen, werden keine Meetings ausgeschlossen.',
    meetingIdsExplanation: 'Geben Sie Meeting-IDs ein, die in die Suchergebnisse einbezogen werden sollen, getrennt durch Kommas. Wenn leer gelassen, werden alle Meetings berücksichtigt.',
    none: '- Keine -',
    ...
    paginationExplanation: 'Kontrollieren Sie die Anzahl der Ergebnisse pro Seite und welche Seite abgerufen werden soll. Leer lassen, um alle Ergebnisse zu erhalten.',
  ...
  en: {
    ...
    field: 'Field',
    formatIds: 'Filter by specific format IDs',
    formatIdsExclude: 'Exclude specific format IDs',
    formatIdsExcludeExplanation: 'Select format IDs to exclude from the results. If none are selected, no formats will be excluded.',
    formatIdsExplanation: 'Select format IDs to include in the results. If none are selected, all formats will be included.',
    formatKeyStrings: 'Filter by format key strings',
    formatKeyStringsExplanation: 'Select format key strings to filter by. If none are selected, all formats will be considered.',
    formatLanguage: 'Format language',
    ...
    meetingIds: 'Search for specific meeting IDs',
    meetingIdsExclude: 'Exclude specific meeting IDs',
    meetingIdsExcludeExplanation: 'Enter meeting IDs to exclude from the search results, separated by commas. If left blank, no meetings will be excluded.',
    meetingIdsExplanation: 'Enter meeting IDs to include in the search results, separated by commas. If left blank, all meetings will be considered.',
    ...
    paginationExplanation: 'Control the number of results per page and which page to retrieve. Leave blank to get all results.',
